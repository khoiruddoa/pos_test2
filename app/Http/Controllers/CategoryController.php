...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect('/dashboard/categories')->with('success', 'Barang baru telah diubah');
    }
    ...
    public function destroy(Category $category)
    {
        ...
        if ($buy != null) {
            if ($buy->category_id == $category->id) {
                return redirect('/dashboard/categories')->with('failed', 'Barang tidak bisa dihapus. karena sudah ada transaksi');
            }
        }
